# -*- coding: utf-8 -*-
"""
Created on Tue Apr 16 10:15:54 2019

Title: Sentiment Analysis on scrapped Tweets using Python
...
class main_loop():
	def __init__(self):
		...
		consumer_key 	= 'lXZLrscZivh0OI9g8P0jAYAG2'		# <--- EDIT ME:  Enter the key here
		consumer_secret	= '1HUieiYCXtE3cdjuccbX1Jo2NXguWBA7LuNWvk6pmXlpGxU94I'		# <--- EDIT ME:  Enter the secret here
		
		# After the step above, you will be redirected to your app's page.
		# Create an access token under the the "Your access token" section
		access_token 		= '1118147812305326082-pj6cE4lSeGWodVtuLiawt0kKkBBoXf'		# <--- EDIT ME:  Enter the token here
		access_token_secret = 'LiufawsDzUSsZxQWWKsnvV1XcRQsrwnrNGUcZpinPH18H'		# <--- EDIT ME:  Enter the token secret here
